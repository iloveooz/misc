// Напишите программу, которая выводит все решения ребуса ТРИ+ДВА=ПЯТЬ в лексикографическом порядке. 
// Одинаковым буквам соответствуют одинаковые цифры. Разным буквам соответствуют разные цифры. 
// Решения надо пронумеровать, отделяя номер от ответа знаком табуляции "\t".
#include <iostream>
